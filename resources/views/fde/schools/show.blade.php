                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 text-xs uppercase text-gray-400">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left">Class</th>
                            <th class="px-4 py-3 text-center text-blue-600">Reg Boys</th>
                            <th class="px-4 py-3 text-center text-pink-600">Reg Girls</th>
                            <th class="px-4 py-3 text-center text-purple-600">OOSC B</th>
                            <th class="px-4 py-3 text-center text-pink-600">OOSC G</th>
                            <th class="px-4 py-3 text-center text-orange-600">P2P B</th>
                            <th class="px-4 py-3 text-center text-pink-600">P2P G</th>
